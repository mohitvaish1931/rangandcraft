    ...
    <div className="policy-page-v2" style={{ 
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '80px 20px', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '60px' }}>
          <span style={{ color: '#c48f56', letterSpacing: '4px', fontWeight: '800', fontSize: '0.7rem', textTransform: 'uppercase', display: 'block', marginBottom: '20px' }}>SERVICE</span>
          <h1 className="font-serif" style={{ fontSize: '3.5rem', fontWeight: '700', marginBottom: '15px', color: '#295454' }}>Refund Policy</h1>
        ...
        <div style={{ 
          ...
          <h2 className="font-serif" style={{ fontSize: '2.2rem', marginBottom: '10px', color: '#295454' }}>RAISE A REQUEST</h2>
          <div style={{ width: '40px', height: '1.5px', backgroundColor: '#c48f56', margin: '0 auto 20px' }}></div>
